      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid gap-12 md:grid-cols-3">
          ...
          >
            ...
            <p className="mt-4 font-sans text-sm leading-relaxed text-gris-pierre">
          ...
          >
            ...
            <div className="mt-4 space-y-3 font-sans text-sm text-creme/70">
              <p>23 Avenue Victor Hugo</p>
              <p>12000 Rodez</p>
              <p>
                <Link
                  href="tel:+33565688143"
                  className="transition-colors hover:text-or-ambre"
                >
                  05 65 68 81 43
                </Link>
              </p>
        ...
        {/* Bottom Bar */}
        <div
          className={`mt-16 border-t border-creme/10 pt-8 transition-all duration-700 delay-500 ${
